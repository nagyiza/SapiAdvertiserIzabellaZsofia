...
public class AddEsemenyActivity extends BaseActivity implements View.OnClickListener, OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_esemeny);
    ...
    private void AddEsemeny() {
        ...
        if (user == null) {
            Toast.makeText(AddEsemenyActivity.this, "Not exist user", Toast.LENGTH_SHORT).show();
        } else {
            if(title.length() != 0 && detail.length() != 0) {
                id = user.getUid();

                mDatabase = FirebaseDatabase.getInstance().getReference("esemenyek");

                //save image's download uri in database
                EsemenySave(imageURIs);

            }else{
                Toast.makeText(AddEsemenyActivity.this, "The input is empty", Toast.LENGTH_SHORT).show();
            }
        }
    }
     ...
     */
    private void EsemenySave(final ArrayList<Uri> mImageUri) {
        ...
        if(mImageUri == null){
            ...
            Intent intent = new Intent(AddEsemenyActivity.this, EsemenyekActivity.class);
            ...
            for (Uri photoUri : mImageUri) {
                ...
                final StorageReference photoRef = mStorageRef.child("EsemenyekPhotos").child(key).child(photoUri.getLastPathSegment());
                // [END get_child_ref]

                photoRef.putFile(photoUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    @Override
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        Toast.makeText(AddEsemenyActivity.this, "Upload succes ", Toast.LENGTH_SHORT).show();
                        hideProgressDialog();
                        ...
                        if (counter == mImageUri.size()) {
                            ...
                            Intent intent = new Intent(AddEsemenyActivity.this, AdvertisementListActivity.class);
                            intent.putExtra("Type", "allAdvertisement");
                            startActivity(intent);
                            finish();
                        }
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(AddEsemenyActivity.this, "Upload failed", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            Toast.makeText(AddEsemenyActivity.this, "The permissions are oke",Toast.LENGTH_SHORT).show();
        }

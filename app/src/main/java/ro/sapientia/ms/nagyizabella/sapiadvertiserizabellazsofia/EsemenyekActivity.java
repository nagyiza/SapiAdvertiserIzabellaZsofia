...
public class EsemenyekActivity extends BaseActivity implements View.OnClickListener, RecyclerViewAdapter.ItemClickListener, RecyclerViewAdapter.ItemLongClickListener{
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_esemenyek);
        ...
        mAdapter = new RecyclerViewAdapter(EsemenyekActivity.this, advertisements);
    ...
    private void LoadAdvertisement() {
        myRef.child("esemenyek").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot adventisementKey : dataSnapshot.getChildren()) {
                    ...
                    if(hide.equals("false")) { //if the advertisement not is hide
                        if (type.equals("myAdvertisement")) {
                            ...
                            if (currentUser == null) {
                                Toast.makeText(EsemenyekActivity.this, "You are not sign in", Toast.LENGTH_LONG).show();
                                Intent intent = new Intent(EsemenyekActivity.this, SignInActivity.class);
                ...
                mAdapter = new RecyclerViewAdapter(EsemenyekActivity.this, advertisements);
                mAdapter.setClickListener(EsemenyekActivity.this);
                mAdapter.setLongClickListener(EsemenyekActivity.this);
                recyclerView.setAdapter(mAdapter);
            }
            @Override
     ...
     */
    private void newEsemeny() {
        FirebaseUser currentUser = FirebaseAuth.getInstance().getCurrentUser();
        if(currentUser != null){
            Intent signInIntent = new Intent(EsemenyekActivity.this, AddEsemenyActivity.class);
            startActivity(signInIntent);
            finish();
        }else{
            Intent signInIntent = new Intent(EsemenyekActivity.this, SignInActivity.class);
            startActivity(signInIntent);
            finish();
        }
    ...
    public void onItemClick(View v, int position) {
        Intent intent = new Intent(EsemenyekActivity.this, AdvertisementData.class);
    ...
    public void onItemLongClick(View v, final int position) {
        ...
        if(user.getUid().equals(mAdapter.getUserId(position))){
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(EsemenyekActivity.this);
            // set title
